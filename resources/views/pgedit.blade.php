...
@endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/delete/{{$site->id}}" method="post">
                @csrf
                ...
                @enderror
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="page title" name="link" value="{{$site->link}}">
                      </div> 
                    @error('title')
                    <div class="error text-danger">{{ $message }}</div>
                @enderror
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="page title" name="title"  value="{{$site->title}}">
                      </div>
                  ...
                  @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="content" id="exampleFormControlTextarea1" rows="3">{{$site->content}}</textarea>
                      </div>
