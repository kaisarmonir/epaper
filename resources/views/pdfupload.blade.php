...
@endif
              <div class="card-header">
                <h3 class="card-title">Select pdf</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{url('pdf-upload')}}" method="post" enctype="multipart/form-data">
                @csrf
...
@enderror
                    <label for="imageInput2">Pdf</label>
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="pdf" id="imageInput2" >
