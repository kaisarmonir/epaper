...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <li class="nav-header">MORE</li>
          <li class="nav-item">
            <a href="https://demo.naadunedu.com/page/create" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Create page
...
@endif
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$site->link}}</td>
      <td><a href="/page/{{$site->id}}/edit"><button class="btn btn-primary">edit</button> </a><form action="/page/{{$site->id}}", method='post'>
                            @csrf
                            @method('DELETE')<button class="btn btn-primary" type="submit" onclick=" return confirm('Are you sure to delete?');">delete</button></form></td>
